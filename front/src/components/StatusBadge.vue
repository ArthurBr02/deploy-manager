<template>
  <span :class="['inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full text-xs font-medium border', cls]">
    <span v-if="status === 'IN_PROGRESS'" class="dm-spin" style="width:8px;height:8px;border-width:1.5px" />
