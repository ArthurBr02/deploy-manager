...
public record HostWithStatusResponse(UUID id, String name, String ip, String domain, String sshUser, Integer sshPort,
    ...
    public static HostWithStatusResponse from(Host h, String lastStatus, Instant lastAt, boolean canDeploy, boolean canEdit, boolean canExecute, boolean isDumpAvailable) {
